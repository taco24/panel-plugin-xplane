...
#define CB_READ_UPPER_FINE_TUNING_MASK (0x000000)
#define CB_READ_UPPER_COARSE_TUNING_MASK (0x000000)
#define CB_READ_UPPER_FINE_RIGHT     (0x000000)
#define CB_READ_UPPER_FINE_LEFT      (0x000000)
#define CB_READ_UPPER_COARSE_RIGHT   (0x000000)
#define CB_READ_UPPER_COARSE_LEFT    (0x000000)
